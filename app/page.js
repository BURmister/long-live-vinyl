...
export default async function Home() {
   const NEW_VINYL = await fetchGetQuery('http://95.174.93.98:1337/api/products/?filters[new]=true&pagination[pageCount]=8');
   const MONTH_VINYL = await fetchGetQuery('http://95.174.93.98:1337/api/products/?filters[bestseller]=true&pagination[pageCount]=8');
   const RARE_VINYL = await fetchGetQuery('http://95.174.93.98:1337/api/products/?filters[rare]=true&pagination[pageCount]=8');
